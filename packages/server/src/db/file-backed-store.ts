...
export const CASCADES: Array<{ parent: FileBackedTable; child: FileBackedTable; parentKey: string; childKey: string }> =
  [
    ...
    { parent: "character_daily_memory_runs", child: "character_daily_memory_run_sources", parentKey: "id", childKey: "runId" },
    { parent: "character_daily_memory_run_sources", child: "character_daily_memories", parentKey: "id", childKey: "runSourceId" },
