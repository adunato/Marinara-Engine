...
export const FILE_BACKED_TABLES = [
  ...
  "character_daily_memory_settings",
  "character_daily_memory_days",
  "character_daily_memory_runs",
...
const SHARD_KEY_COLUMNS: Record<string, string> = {
  ...
  character_daily_memory_settings: "characterId",
  character_daily_memory_days: "characterId",
  character_daily_memory_runs: "dayId",
  character_daily_memory_run_sources: "runId",
  character_daily_memories: "characterId",
  character_briefings: "characterId",
...
export const CASCADES: Array<{ parent: FileBackedTable; child: FileBackedTable; parentKey: string; childKey: string }> =
  [
    ...
    { parent: "characters", child: "character_daily_memory_settings", parentKey: "id", childKey: "characterId" },
    { parent: "characters", child: "character_briefings", parentKey: "id", childKey: "characterId" },
    { parent: "characters", child: "character_daily_memory_days", parentKey: "id", childKey: "characterId" },
    { parent: "character_daily_memory_days", child: "character_daily_memory_runs", parentKey: "id", childKey: "dayId" },
    {
      parent: "character_daily_memory_runs",
      child: "character_daily_memory_run_sources",
      parentKey: "id",
      childKey: "runId",
    },
    {
      parent: "character_daily_memory_run_sources",
      child: "character_daily_memories",
      parentKey: "id",
      childKey: "runSourceId",
    },
    { parent: "character_daily_memory_days", child: "character_daily_memories", parentKey: "id", childKey: "dayId" },
    { parent: "character_daily_memory_runs", child: "character_daily_memories", parentKey: "id", childKey: "runId" },
